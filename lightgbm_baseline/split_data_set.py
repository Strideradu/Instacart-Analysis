...
if __name__ == '__main__':
    ...
    labels = pd.read_pickle('/mnt/home/dunan/Learn/Kaggle/instacart/data/previous_products.pkl')
    ...
    for fold in range(folds):
        ...
        current.to_pickle('/mnt/home/dunan/Learn/Kaggle/instacart/data/chunk_{}.pkl'.format(fold))